...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <aside style="background-color:RGB(40, 178, 170);" class="main-sidebar sidebar-light elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span style="color: RGB(245, 245, 245); font-style: bold;" class="brand-text font-weight-dark">Template</span>
      </a>
            ...
            <li style="font-style: bold; font-size: bold; color: RGB(245, 245, 245);" class="nav-header">Main </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('views_table') ?>" class="nav-link">
                      <i class="far fa-stop-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">views_table</p>
                    </a>
                  </li>
                </ul>
  ...
  <script src="<?= base_url() ?>assets/backend/plugins/jquery/jquery.min.js"></script>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a class="text-info" href="https://Template/">Template</a>.</strong> All rights reserved.
    </footer>
