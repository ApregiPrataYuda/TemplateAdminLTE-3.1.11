...
<div class="login-box">
  ...
  <div class="card card-outline card-info">
    <div class="card-header text-center">
      <a href="" class="h1" style="color:RGB(40, 178, 170);"><b style="color:RGB(40, 178, 170);">Login</b>-page</a>
    </div>
    <div class="card-body">
      ...
      <small class="text-danger" style="font-style: italic "><span class="badge badge-danger"><?=form_error('nik')?></span></small>
        <div class="input-group mb-3 <?=form_error('nik') ? 'has-error' : null?>">
          <input type="text" name="nik" class="form-control" value="<?=set_value('nik')?>" placeholder="NIK">
